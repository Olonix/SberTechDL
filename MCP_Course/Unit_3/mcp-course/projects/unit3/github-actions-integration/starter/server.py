    ...
    try:
        ...
        for event in events:
            if "workflow_run" in event:
                name = event["workflow_run"].get("name", "Unknown")
                status = event["workflow_run"].get("status", "unknown")
                conclusion = event["workflow_run"].get("conclusion", "None")
...
async def analyze_ci_results():
    ...
    return "Use the get_recent_actions_events and get_workflow_status tools to check the latest CI/CD runs. Identify any failed tests and explain the cause of the errors."
...
async def create_deployment_summary():
    ...
    return "Check the status of the recent workflows and provide a concise, clear summary of the current project deployment state."
...
async def generate_pr_status_report():
    ...
    return "Use the file analysis tools along with the CI/CD tools to generate a complete PR status report: summarize what changed in the code and whether the tests passed."
...
async def troubleshoot_workflow_failure():
    ...
    return "Find the most recent failed workflow. Based on the error logs, provide a step-by-step debugging checklist."
